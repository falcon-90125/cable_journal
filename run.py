...
for i in range(len(data)):
    ...
    if type(stroka['Позиция']) == str and type(stroka['Начало']) == str and type(stroka['Конец']) == str:
        okns = stroka['Обозначение КНС'].split(";_x000D_\n") # Разбираем данные по делителю, записываем с список
        gkns = stroka['Габариты КНС'].split(";_x000D_\n") # Разбираем данные по делителю, записываем с список
        dkns = stroka['Длина в КНС'].split(";_x000D_\n") # Разбираем данные по делителю, записываем с список
